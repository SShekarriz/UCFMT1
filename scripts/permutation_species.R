...
marker_lvl_RA <- read.csv("../data/species_lvl_RA.csv")


### donorB species and set engraftment cutoff
marker_lvl_RA %>%
...
write.table(auc_null, "../permut_data/species_auc_null.txt",
...
write.table(rm_auc_null, "../permut_data/species_remission_auc_null.txt",
            sep = "\t", row.names = F, quote = F)
