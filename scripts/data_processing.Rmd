...
fig_16s = c('donorB_16s_samples','profile_16s', 'profile_16s_don')
...
fig_st = c('donorB_strains_all', 'profile_st',
           'profile_st_don')
...
fig_ge = c('profile_ge', 'profile_ge_don')
