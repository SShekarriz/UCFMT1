...
marker_lvl_RA <- read.csv("../data/marker_lvl_RA.csv")
...
write.table(auc_null, "../permut_data/strains_auc_null.txt",
...
write.table(rm_auc_null, "../permut_data/strains_remission_auc_null.txt",
            sep = "\t", row.names = F, quote = F)
